...
if (isset($_POST['update'])) {
    ...
    $stmt->execute([$update_quantity, $total_price, $update_cart_id]);
    ...
    ?>
        <table style="width: 70%; align-items:center; margin:10px auto;">
            ...
            <tbody>
                <?php
                $total = 0;
                $stmt = $conn->prepare("SELECT id, name, price, image, quantity, total FROM cart WHERE user_id = ?");
                ...
                ?>
                        <tr>
                            ...
                            <td><?php $sub_total = $row['price'] * $row['quantity']; echo number_format($sub_total); ?></td>
                        </tr>
                <?php
                        $total += $sub_total;
                    }
